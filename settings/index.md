...
| Worker Size                     | int                     | Advanced: Changes how many nodes/connections a single worker in a ParallelFor is in charge of. Can be changed using the `Conveyor.WorkerSize` console command.                              | 1024          |
